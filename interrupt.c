...
/*
 * This function installs a timer signal handler in the calling program using the sigaction system call.
 * When a timer signal fires, the function interrupt_handler in the interrupt.c file is invoked.
 * With the verbose flag, a message is printed when the handler function runs.
 */
void
